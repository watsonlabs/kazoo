...
reload_acls(JObj) -> reload_acls(wh_json:to_proplist(JObj)).
...
reload_acls_v(JObj) ->reload_acls_v(wh_json:to_proplist(JObj)).
...
reload_gateways(JObj) -> reload_gateways(wh_json:to_proplist(JObj)).
...
reload_gateways_v(JObj) ->reload_gateways_v(wh_json:to_proplist(JObj)).
